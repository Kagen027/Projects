        ...
        <body class="flex-col">
            ...
            <main class="flex-col">
                <div class="center space7">
                    ...
                    <div>&nbsp;</div>
                    <div class="intro">Used Vehicle Invetory</div>
                </div>
                <div id="vehicles" class="center flex-row">
                    <c:forEach var="soldVehicles" items="${soldVehicles}">
                        <div id="vehicle-box" class="flex-col">
                            <c:choose>
                                <c:when test="${over120 == true}">
                                    <div id="title-box" class="flex-row space2">
                                        <div class="title">${soldVehicles.getYear()}</div>
                                        <div class="title">${soldVehicles.getMake()}</div>
                                        <div class="title">${soldVehicles.getModel()}</div>
                                        <div class="justify-right full-width">
                                            <div class="dollar">$</div>
                                            <div class="price-120">${soldVehicles.getPrice()}</div>
                                        </div>
                                    </div>
                                    <div class="flex-col vehicle-info">
                                        <div id="title-box" class="flex-row space2">
                                            <div class="discount">
                                                <div class="explenation">!!</div>&nbsp;Tire Burner Special, Hurry Now
                                                for 10% Off&nbsp;<div class="explenation">!!</div>
                                            </div>
                                ...
                                <c:otherwise>
                                    <div id="title-box" class="flex-row space2">
                                        ...
                                        <div class="justify-right full-width">
                                            <div class="dollar">$</div>
                                            <div class="price">${soldVehicles.getPrice()} </div>
                                        </div>
                                    </div>
                                </c:otherwise>
                            </c:choose>
                            <div class="flex-col vehicle-info">
                                <div>Engine:
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${soldVehicles.getEngine()}
                                </div>
                                <div>Drivetrain:
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${soldVehicles.getDriveTrain()}
                                </div>
                                <div>Transmission:
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${soldVehicles.getTransmission()}
                                </div>
                                <div>Type:
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${soldVehicles.getType()}
                                </div>
                                <div>Doors:
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${soldVehicles.getDoor()}
                                    Door</div>
                                <div>Exterior Color:
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${soldVehicles.getExteriorColor()}</div>
                                <div id="title-box" class="flex-row">
                                    <div class="add-width">Interior Color:
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${soldVehicles.getInteriorColor()}
                                    </div>
                                    <div class="justify-right full-width"><button
                                            onclick="window.location.href='/details/${soldVehicles.getId()}'"
                                            class="button-1" role="button">Buyer Info</button></div>
                                </div>
                            </div>
                            <img src="${soldVehicles.getPic()}" />
                            <div id="sold">Sold</div>
                            <div id="date">${soldVehicles.getDateSold()}</div>
                        </div>
                    </c:forEach>
                        ...
                        <c:choose>
                            <c:when test="${allVehicles.getSold() != true}">
                                <div id="vehicle-box" class="flex-col">
                                    <c:choose>
                                        <c:when test="${over120 == true}">
                                            <div id="title-box" class="flex-row space2">
                                                ...
                                                <div class="justify-right full-width">
                                                    <div class="dollar">$</div>
                                                    <div class="price-120">${allVehicles.getPrice()}</div>
                                                </div>
                                            </div>
                                            <div class="flex-col vehicle-info">
                                                <div id="title-box" class="flex-row space2">
                                                    <div class="discount">
                                                        <div class="explenation">!!</div>&nbsp;Tire Burner Special,
                                                        Hurry Now for 10% Off&nbsp;<div class="explenation">!!</div>
                                                    </div>
                                                    <div id="reduced-price" class="justify-right full-width">
                                                        <div class="dollar">$</div>
                                                        <div class="price">${reducePrice}</div>
                                        ...
                                        <c:otherwise>
                                            <div id="title-box" class="flex-row space2">
                                                ...
                                                <div class="justify-right full-width">
                                                    <div class="dollar">$</div>
                                                    <div class="price">${allVehicles.getPrice()} </div>
                                                </div>
                                            </div>
                                        </c:otherwise>
                                    </c:choose>
                                    <div class="flex-col vehicle-info">
                                        <div>Engine:
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${allVehicles.getEngine()}
                                        </div>
                                        <div>Drivetrain:
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${allVehicles.getDriveTrain()}
                                        </div>
                                        <div>Transmission:
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${allVehicles.getTransmission()}
                                        </div>
                                        <div>Type:
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${allVehicles.getType()}
                                        </div>
                                        <div>Doors:
                                            ...
                                            Door</div>
                                        <div>Exterior Color:
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${allVehicles.getExteriorColor()}
                                        </div>
                                        <div id="title-box" class="flex-row">
                                            <div class="add-width">Interior Color:
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${allVehicles.getInteriorColor()}
                                            </div>
                                            <div class="justify-right full-width"><button
                                                    onclick="window.location.href='/details/${allVehicles.getId()}'"
                                                    class="button-1" role="button">Details</button></div>
                                        </div>
                                    </div>
